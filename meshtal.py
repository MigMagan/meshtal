...
def add(tallylist):
    ...
    Result.comment = "Tallies added: {valor}".format(valor=[tally.n for tally in tallylist])
    Result.value = sum(tally.value for tally in tallylist)
    totnps = sum(tally.nps for tally in tallylist)
